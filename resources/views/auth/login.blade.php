...
<div class="container login-logout" id="container" style="margin-top:6.1rem;">
...
<div class="login-logout-sano">
    ...
    <div class="card sign-up-container-sano m-4 py-4" align="center" id="sign-up-container-sano">
        <form method="POST" action="{{ route('register') }}" id="form">
            ...
            <input id="password" type="password" placeholder="Enter Password"
                   class="form-control mt-3 input-sm @error('password') is-invalid @enderror" name="password"
            ...
            Already registered? <span><a href="#sign-in-container-sano"
                                         class="sign-in-jau mt-2">Sign In Here</a></span>
...
<style>
    ...
    .login-logout {
        ...
        border-radius: 10px;
        box-shadow: 0 10px 18px rgba(0, 0, 0, 0.25), 5px 10px 10px rgba(0, 0, 0, 0.22);
        position: relative;
        overflow: hidden;
        width: 768px;
        max-width: 100%;
    ...
    .login-logoutr.right-panel-active .sign-in-container {
