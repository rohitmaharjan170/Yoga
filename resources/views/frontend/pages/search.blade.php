...
@section('content')
    <div class="gallery-page row mx-4 mt-4">
    ...
    @if(isset($details))
        <h3 class="text-center mb-5" style="font-family: Bebas Neue">Your search result for <b
                    style="text-transform: uppercase"> {{ $query }} </b> :</h3>
    ...
    {{$details->links()}}
    @else
    <h3 class="text-center mb-5" style="font-family: Bebas Neue">{{$message}}</h3>
@endif
@endsection